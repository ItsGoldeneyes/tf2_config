		...
		"PlaylistBGPanel"
		{
			...
			"MatchHistoryCategories"
			{
				...
				"SortArrow"
				{
					...
					"defaultFgColor_override" "GoldHUDGray"
					"armedFgColor_override"	"GoldHUDGray"
					"selectedFgColor_override" "GoldHUDGray"
				}
				...
				"ResultButton"
				{
					...
					"selectedFgColor_override" "GoldHUDWhite"
